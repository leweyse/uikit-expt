...
export const Tooltip: (
  props: TooltipProperties & RefAttributes<ContainerRef>,
...
export const TooltipTrigger: (
  props: TooltipTriggerProperties & RefAttributes<ContainerRef>,
...
export const TooltipContent: (
  props: TooltipContentProperties & RefAttributes<ContainerRef>,
